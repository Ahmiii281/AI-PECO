...
class TestBillingAPI:
    ...
    async def test_billing_estimate_endpoint(self, client, auth_headers):
        resp = await client.post(
            ...
            json={"kwh": 200, "category": "A1 Residential"},
